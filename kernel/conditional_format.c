...
VTIFUL_STARTUP_FUNCTION(conditional_format)
{
    ...
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_ARROWS_COLORED",          LXW_CONDITIONAL_ICONS_3_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_ARROWS_GRAY",            LXW_CONDITIONAL_ICONS_3_ARROWS_GRAY)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_FLAGS",                  LXW_CONDITIONAL_ICONS_3_FLAGS)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_TRAFFIC_LIGHTS_UNRIMMED", LXW_CONDITIONAL_ICONS_3_TRAFFIC_LIGHTS_UNRIMMED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_TRAFFIC_LIGHTS_RIMMED",  LXW_CONDITIONAL_ICONS_3_TRAFFIC_LIGHTS_RIMMED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_SIGNS",                  LXW_CONDITIONAL_ICONS_3_SIGNS)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_SYMBOLS_CIRCLED",        LXW_CONDITIONAL_ICONS_3_SYMBOLS_CIRCLED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_3_SYMBOLS_UNCIRCLED",      LXW_CONDITIONAL_ICONS_3_SYMBOLS_UNCIRCLED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_4_ARROWS_COLORED",         LXW_CONDITIONAL_ICONS_4_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_4_ARROWS_GRAY",            LXW_CONDITIONAL_ICONS_4_ARROWS_GRAY)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_4_RED_TO_BLACK",           LXW_CONDITIONAL_ICONS_4_RED_TO_BLACK)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_4_RATINGS",                LXW_CONDITIONAL_ICONS_4_RATINGS)
    ...
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_5_ARROWS_COLORED",         LXW_CONDITIONAL_ICONS_5_ARROWS_COLORED)
    REGISTER_CLASS_CONST_LONG(vtiful_conditional_format_ce, "ICON_STYLE_5_ARROWS_GRAY",            LXW_CONDITIONAL_ICONS_5_ARROWS_GRAY)
